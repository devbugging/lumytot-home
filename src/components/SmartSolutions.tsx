  ...
  return <section className="py-32 bg-background">
      <div className="container mx-auto px-6 md:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">Designed by parents for parents, Lumy•tot makes sleep routines simple. One light, zero buttons, all controlled in the app.</p>
        </div>
