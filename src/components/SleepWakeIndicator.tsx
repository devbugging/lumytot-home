      ...
      <div className="container mx-auto px-6 md:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
          ...
          <div className="space-y-6">
            {/* Introduction Card */}
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 border border-warm-green/20 shadow-lg">
            ...
            {/* Wake Up Card */}
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 border border-warm-orange/20 shadow-lg">
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#738871' }}>
                  <Sun className="w-7 h-7" style={{ color: '#E9E7E5' }} />
                </div>
            ...
            {/* Sleep Card */}
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 border border-warm-brown/20 shadow-lg">
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#738871' }}>
                  <Moon className="w-7 h-7" style={{ color: '#E9E7E5' }} />
                </div>
                <div className="flex-1">
            ...
            {/* Summary Card */}
            <div className="rounded-2xl p-8 border-2 border-warm-green/30" style={{ backgroundColor: '#E9E7E5' }}>
              <p className="text-custom leading-relaxed font-medium">
