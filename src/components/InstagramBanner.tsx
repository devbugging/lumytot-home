        ...
        <div className="bg-gradient-card rounded-2xl p-8 md:p-12 text-center border border-border/50 shadow-soft">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative">
              ...
              <div className="absolute -top-4 -left-12 w-20 h-20 rounded-xl overflow-hidden border-3 border-white shadow-xl transform -rotate-12 hover:scale-105 transition-transform">
              ...
              <div className="absolute -top-4 -right-12 w-20 h-20 rounded-xl overflow-hidden border-3 border-white shadow-xl transform rotate-12 hover:scale-105 transition-transform">
              ...
              <div className="absolute -bottom-4 -left-10 w-16 h-16 rounded-xl overflow-hidden border-3 border-white shadow-xl transform rotate-6 hover:scale-105 transition-transform">
                <img src="/lovable-uploads/4429646c-d357-4686-9995-105bc97b2ef7.png" alt="Peaceful sleep" className="w-full h-full object-cover" />
              </div>
              <div className="absolute -bottom-4 -right-10 w-16 h-16 rounded-xl overflow-hidden border-3 border-white shadow-xl transform -rotate-6 hover:scale-105 transition-transform">
                <img src="/lovable-uploads/6422a9c3-d6a4-4411-a930-92344931a381.png" alt="Sweet dreams" className="w-full h-full object-cover" />
              </div>
              <div className="absolute top-8 -left-16 w-14 h-14 rounded-lg overflow-hidden border-2 border-white shadow-lg transform rotate-45 hover:scale-105 transition-transform">
                <img src="/lovable-uploads/1a3bf8d1-3952-4b4d-8971-dd6a1801ddff.png" alt="Family time" className="w-full h-full object-cover" />
              </div>
              <div className="absolute top-8 -right-16 w-14 h-14 rounded-lg overflow-hidden border-2 border-white shadow-lg transform -rotate-45 hover:scale-105 transition-transform">
