        ...
        <div className="bg-gradient-card rounded-2xl p-8 md:p-12 text-center border border-border/50 shadow-soft">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative">
              ...
              {/* Photo mash around the icon - bigger sizes */}
              <div className="absolute -top-6 -left-16 w-28 h-28 rounded-xl overflow-hidden border-3 border-white shadow-xl transform -rotate-12 hover:scale-105 transition-transform">
              ...
              <div className="absolute -top-6 -right-16 w-28 h-28 rounded-xl overflow-hidden border-3 border-white shadow-xl transform rotate-12 hover:scale-105 transition-transform">
              ...
              <div className="absolute -bottom-6 -left-14 w-24 h-24 rounded-xl overflow-hidden border-3 border-white shadow-xl transform rotate-6 hover:scale-105 transition-transform">
                <img src="/lovable-uploads/4429646c-d357-4686-9995-105bc97b2ef7.png" alt="Peaceful sleep" className="w-full h-full object-cover" />
              </div>
              <div className="absolute -bottom-6 -right-14 w-24 h-24 rounded-xl overflow-hidden border-3 border-white shadow-xl transform -rotate-6 hover:scale-105 transition-transform">
                <img src="/lovable-uploads/6422a9c3-d6a4-4411-a930-92344931a381.png" alt="Sweet dreams" className="w-full h-full object-cover" />
              </div>
              <div className="absolute top-10 -left-20 w-20 h-20 rounded-lg overflow-hidden border-2 border-white shadow-lg transform rotate-45 hover:scale-105 transition-transform">
                <img src="/lovable-uploads/1a3bf8d1-3952-4b4d-8971-dd6a1801ddff.png" alt="Family time" className="w-full h-full object-cover" />
              </div>
              <div className="absolute top-10 -right-20 w-20 h-20 rounded-lg overflow-hidden border-2 border-white shadow-lg transform -rotate-45 hover:scale-105 transition-transform">
